...
- умеет принимать те же вложения и в web-интерфейсе
...
- вложения в Telegram и web поддерживаются только в форматах: изображения, PDF, DOC, DOCX, XLSX и текстовые файлы
